package com.am.sweater;

import com.am.sweater.controller.MessageController;
...
public class MessageControllerTest {
    ...
    public void addMessageToListTest() throws Exception {
        ...
        this.mockMvc.perform(multipart)
                ...
                .andExpect(xpath("//div[@id='message-list']/div[@data-id='10']/div/span").string("some text"))
                .andExpect(xpath("//div[@id='message-list']/div[@data-id='10']/div/i").string("#tag10"));
    }
}
